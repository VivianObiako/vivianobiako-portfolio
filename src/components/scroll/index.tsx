...
const Scroll = () => {
    ...
    return (
        ...
        <div className='scrolling-section hide-scroll focus-visible:outline-none flex flex-col gap-0 justify-between px-5 sm:px-10 pb-20 lg:pb-[90px] lg:pt-0 lg:pr-[90px] lg:pl-10 md:w-1/2 md:justify-self-end'>
            ...
            <SectionHeading isDark={isDark} id='section3' className='section3' title='Work'>
                <div className='group grid lg:mt-[35px] lg:grid-cols-2 gap-x-[15px] pb-20 md:pb-0'>
